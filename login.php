...
<head>
    ...
    <title>Login Admin dan Petugas | Sistem Informasi Arsip Digital</title>
...
<div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <img src="unima.png" width="55" height="90">               
            <img src="tutwurii.png" width="78" height="87">
            <br>
            <br>
            <h4 style="color:#FF0000;">JURUSAN PENDIDIKAN TEKNOLOGI INFORMASI DAN KOMUNIKASI</h4><h4>BIDANG ADMINISTRASI</h4>
            <h5>Sistem Informasi Arsip Digital (SIAD)</h5>
            <link id="favicon" rel="shortcut icon" type="image/png" href="unima.PNG">
                
            <marquee>Silahkan Login untuk mengakses Sistem Informasi Arsip Digital (SIAD)</marquee>
